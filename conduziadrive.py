...
def train():
    ...
    drive = PPO(MlpPolicy, env, gamma=0.9997, gae_lambda=1, ent_coef=0.01, vf_coef=1, batch_size=256, learning_rate=5e-6, clip_range=0.1, n_steps=4096, n_epochs=30, verbose=1).learn(total_timesteps=1600000)
