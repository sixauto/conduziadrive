...
def train():
    ...
    #Cria o agent
    drive = PPO(MlpPolicy, env, gamma=0.9997, gae_lambda=1, ent_coef=0.01, vf_coef=1, batch_size=256, learning_rate=5e-6, clip_range=1, n_steps=32, n_epochs=20, verbose=1)
    # Treina o agent
    drive = drive.learn(total_timesteps=1000000, n_eval_episodes=30, eval_freq=5)
